...
#'
#' Returns a vector that represents a hyper-plane that linearly separates the binary response in the sample. 
#'
...
#' @param w_0         p+1 length vector at the initial states            
#'
...
perceptron_learning_algorithm = function(Xinput, y_binary, MAX_ITER = 1000, w_0 = NULL){
  ...
  for(iter in 1 : MAX_ITER){
    for(i in 1 : n){
      y_hat_i = ifelse(sum(w_prev*Xinput[i,]) >=0, 1, 0) # dot product 
